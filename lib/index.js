...
import { dshEntry } from './dsh-resolve.mjs';
...
export async function apply(ctx, config) {
   ...
   */
  const askDialog = { open: false, mode: 'selection', at: 0, sessionId: null, polls: 0, lastPollAt: 0 };
  ...
  function askDialogLive() {
    ...
    if (askDialog.polls > 0 && Date.now() - askDialog.lastPollAt < TTL_MS) return true;
