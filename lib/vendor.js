...
//     并**直接挂在插件依赖上**(平台无关的 → dependencies;平台专属的 → optionalDependencies,
//     包自带 os/cpu 按架构自动选)。原始名字由 lib/native.js 按 lib/vendored.json 补 junction ——
//     0.3.45 起不再有平台聚合包,原因见 docs/desktop-first-install-root-cause.md;
